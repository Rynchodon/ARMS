...
namespace Rynchodon.AntennaRelay
{
	...
	public class RadarInfo
	{
		...
		//private float threeSigFig(float toRound)
		//{

		//}

		//private int sigFigToDec(float toRound, int sigFig)
		//{
		...
		//	{
		//		if (Volume > km3)
		//			return (Volume / km3).ToString("F2") + "km3";
		//		if (Volume > hm3)
		//			return (Volume / hm3).ToString("F2") + "hm3";
		//		if (Volume > dam3)
		//			return (Volume / dam3).ToString("F2") + "dam3";
		//		else
		//			return Volume.ToString("F2") + "m3";
		//	}
		//}
