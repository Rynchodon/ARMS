...
namespace Rynchodon.AntennaRelay
{
	...
	public class RemoteControl :  Receiver
	{
		...
		public override void Init(MyObjectBuilder_EntityBase objectBuilder)
		{
			...
			alwaysLog("init as remote: " + CubeBlock.BlockDefinition.SubtypeName, "Init()", Logger.severity.DEBUG);
		}
		...
		public bool TryGet(IMyCubeBlock block, out RemoteControl result)
