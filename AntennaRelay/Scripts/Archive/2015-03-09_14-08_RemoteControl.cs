...
namespace Rynchodon.AntennaRelay
{
	...
	public class RemoteControl :  Receiver
	{
		...
		protected override void DelayedInit()
		{
			...
			{
				log("adding brackets for Germans: " + myRemote.DisplayNameText, "DelayedInit()", Logger.severity.TRACE);
				myRemote.SetCustomName(myRemote.DisplayNameText + " []");
			}
			else
				log("already has brackets: " + myRemote.DisplayNameText, "DelayedInit()", Logger.severity.TRACE);
		}
