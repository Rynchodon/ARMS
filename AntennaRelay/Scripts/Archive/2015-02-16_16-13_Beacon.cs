...
namespace Rynchodon.AntennaRelay
{
	...
	public class Beacon : MyGameLogicComponent
	{
		...
		// sealed for now, to smooth transition. not saving yet anyway.
		...
		protected void alwaysLog(string toLog, string method = null, Logger.severity level = Logger.severity.DEBUG)
		{
			if (myLogger == null)
