...
namespace Rynchodon.AntennaRelay
{
	...
	public class RemoteControl : MyGameLogicComponent, IReceiver
	{
		private static Dictionary<IMyCubeBlock, RemoteControl> registry = new Dictionary<IMyCubeBlock, RemoteControl>();
		...
		private Dictionary<IMyEntity, LastSeen> myLastSeen { get; set; }
		private HashSet<Message> myMessage;
