	...
	public class Antenna : Receiver
	{
		...
		public override void UpdateAfterSimulation100()
		{
			...
			try
			{
				...
				Showoff.doShowoff(CubeBlock, myLastSeen.Values.GetEnumerator());
		...
		{
			log("sending to " + canSeeMe.Count + " enemies and " + listCanSendTo.Count + " friends", "sendTransmission()", Logger.severity.TRACE);
