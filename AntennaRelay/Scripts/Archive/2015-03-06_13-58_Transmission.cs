...
namespace Rynchodon.AntennaRelay
{
	...
	public class RadarInfo
	{
		...
		{
			if (Volume > km3)
				return threeSigFig(Volume / km3) + "TL";
			if (Volume > hm3)
				return threeSigFig(Volume / hm3) + "GL";
			if (Volume > dam3)
				return threeSigFig(Volume / dam3) + "ML";
			if (Volume > 1)
				return threeSigFig(Volume) + "kL";
			return threeSigFig(Volume / dm3) + "L";
		}
