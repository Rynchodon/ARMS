...
namespace Rynchodon.AntennaRelay
{
	...
	// need to use a struct so antennae all have a different copy
	public struct LastSeen //: Transmission
	{
		...
		public LastSeen(IMyEntity entity, bool EntityHasRadar = false, RadarInfo info = null) : this()
		{
		...
		public bool updateWith(LastSeen other)
		{
			...
			if (other.Info != null && (this.Info == null || other.Info.IsNewerThan(this.Info)))
