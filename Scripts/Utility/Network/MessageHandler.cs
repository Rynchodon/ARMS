...
namespace Rynchodon.Utility.Network
{
	...
	public static class MessageHandler
	{
		...
		public enum SubMod : byte { FW_EngagerControl, Message, SyncEntityValue, RequestEntityValue, ServerSettings, GuidedMissile, LoadDistribution, TerminalSync, TerminalSyncRequest }
