...
namespace Rynchodon.Autopilot.Instruction.Command
{
	public class TerminalPropertyBool : TerminalProperty<bool>
	{
		...
		{
			return new TerminalPropertyBool() { m_targetBlock = new StringBuilder(m_targetBlock.ToString()), m_termProp = new StringBuilder(m_termProp.ToString()), m_value = m_value };
		}
