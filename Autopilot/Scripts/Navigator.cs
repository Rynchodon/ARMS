...
namespace Rynchodon.Autopilot
{
	public class Navigator
	{
		...
		//		//		Sandbox.ModAPI.IMyCubeGrid closestGrid = myTargeter.findCubeGrid(out closestBlock, true, dataLowerCase, CNS.searchBlockName);
		...
		//		//		myTargeter.findClosestCubeBlockOnGrid(out landLocalBlock, myGrid, dataLowerCase, true);
