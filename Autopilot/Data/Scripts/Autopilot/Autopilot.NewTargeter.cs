...
namespace Rynchodon.Autopilot
{
	internal class NewTargeter
	{
		...
		public bool lastSeenFriendly(string gridNameContains, out LastSeen bestMatchGrid, out IMyCubeBlock bestMatchBlock, string blockContains = null)
		{
			...
			{
				alwaysLog("failed to get ARRemoteControl for currentRC(" + owner.currentRCblock.DisplayNameText + ")", "lastSeenFriendly()", Logger.severity.WARNING);
