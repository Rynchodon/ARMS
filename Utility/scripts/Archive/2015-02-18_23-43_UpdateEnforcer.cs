...
{
	/// <summary>
	/// Makes sure a MyGameLogicComponent gets the right updates. Can only use UpdateAfterSimulation / 10 / 100. DelayedInit will be delayed by 100 updates. Will set MyObjectBuilder variable.
	/// </summary>
