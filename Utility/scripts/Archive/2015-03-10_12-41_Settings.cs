...
namespace Rynchodon
{
	...
	{
		// Settings
		public enum BoolSetName : byte { bAllowJumpCreative, bAllowJumpSurvival, bAllowAutopilot, bAllowRadar }
		public enum IntSetName : byte { }
		public enum FloatSetName : byte { fDefaultSpeed }
		...
		private static int latestVersion = 18; // in sequence of updates on steam
