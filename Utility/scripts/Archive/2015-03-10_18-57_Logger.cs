...
namespace Rynchodon
{
	...
	public class Logger : Sandbox.Common.MySessionComponentBase
	{
		...
		public void debugLog(string toLog, string methodName, severity level, string primaryState = null, string secondaryState = null) { log(level, methodName, toLog, primaryState, secondaryState); }

		public void log(string toLog, string methodName, severity level, string primaryState = null, string secondaryState = null) { log(level, methodName, toLog, primaryState, secondaryState); }
