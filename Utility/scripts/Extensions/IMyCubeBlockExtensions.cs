...
namespace Rynchodon
{
	public static class IMyCubeBlockExtensions
	{
		...
		public static bool canConsiderHostile(this IMyCubeBlock block, IMyCharacter character)
		{ return toIsHostile(block.getRelationsTo(character.GetPlayer_Safe().PlayerID)); }
