...
namespace Rynchodon.Autopilot.Turret
{
	...
	public class TurretBase : UpdateEnforcer
	{
		...
		private bool targetMeteors, targetPlayers;
		...
		private void getPriorities()
		{
			...
			// could keep a list of entities I do not care about, so I do not have to keep fetching builder
			foreach (IMyEntity entity in entitiesInRange)
			{
				...
				{
					myLogger.debugLog("entity = " + entity.getBestName(), "getPriorities()");
				}
			}
